...
source_test!(
    test_lxml_source,
    "lxml",
    "from lxml import etree; print('ok')"
);
source_test!(
    test_aiohttp_source,
    "aiohttp",
    "import aiohttp; print('ok')"
);
...
source_test!(
    test_matplotlib_source,
    "matplotlib",
    "import matplotlib; print('ok')"
);
